...
try:  # renamed in stablehlo-coreml 0.1.6
    ...
    def hlo_pipeline():
        # the old constant is a single shared object; copy it so set_options
        # below does not mutate global state
        import copy

        return copy.deepcopy(DEFAULT_HLO_PIPELINE)
except ImportError:
    from stablehlo_coreml import build_pass_pipeline as hlo_pipeline
